...
<>
    ...
    <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`}>
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="123">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <Link className="nav-link" aria-current="page" to="/darkmode">About</Link>
            </li>
          </ul>
          ...
          <div className="form-check form-switch mx-2">
            <input className="form-check-input" onClick={props.togglePink} type="checkbox" id="flexSwitchCheckDefault" />
